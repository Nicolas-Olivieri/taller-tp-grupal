...
El [manual de usuario](/docs/manual_del_proyecto.md) es una guía básica para los nuevos usuarios. En el mismo se explica cómo instalar y correr el juego. Además, cuenta con una lista de controles y comandos para usar una vez se esté dentro del juego.
