...
SDL2pp::Point Sprite::get_size() const {
    return size;
}

SDL2pp::Point Sprite::get_position() const {
    return position;
}

SDL2pp::Point Sprite::get_ground_position() const {
    return position + size - render_offset;
}
