...
CreatePlayerDTO::CreatePlayerDTO(const uint8_t body, const uint8_t head, const uint8_t archetype, const uint8_t race) :
...
void CreatePlayerDTO::accept(Serializer &serializer) const {
