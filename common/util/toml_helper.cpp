...
SpriteCategory TomlHelper::get_sprite_category(const std::string& category) {
    const std::map<std::string, SpriteCategory> map = {{"head", SpriteCategory::HEAD},
                                                       ...
                                                       {"goblin", SpriteCategory::GOBLIN},
                                                       {"skeleton", SpriteCategory::SKELETON},
                                                       {"zombie", SpriteCategory::ZOMBIE},
                                                       {"spider", SpriteCategory::SPIDER},
                                                       {"orc", SpriteCategory::ORC},
                                                       {"golem", SpriteCategory::GOLEM},
                                                       ...
                                                       {"safe_zones", SpriteCategory::SAFE_ZONE}};
